  /**
          ...
          //  findPrinters();
             ...
             * however, if used, should replace the <applet></applet> method.  Needed to address 
             * MANIFEST.MF TrustedLibrary=true discrepency between JRE6 and JRE7.
             */
            function deployQZ() {
            	console.log(" >>>>>>>>> Cargando Libreria Impresión Externa en Localhost :D");
               var attributes = {id: "qz", code: 'qz.PrintApplet.class',
                    archive: 'http://192.168.0.13:8079/printLib/qz-print.jar', width: 1, height: 1};
                var parameters = {jnlp_href: 'http://192.168.0.13:8079/printLib/qz-print_jnlp.jnlp',
                ...
                if (qz) {
                    try {
                      ...
                      //  document.getElementById("content").style.background = "#F0F0F0";
                        ...
                        primefacesMessages('error', 'Applet Impresión No Cargado','La comunicación con el applet ha fallado, por favor actualize la versión de Java y Revise las Configuraciones de Seguridad)');
                    }
                }
            }
            ...
            function notReady() {
                ...
                // If a printer hasn't been selected, display a message.
                    ...
                    primefacesMessages('error', 'Error Impresora!','Por favor seleccione una impresora antes de Utilizar el Boton de Detección');
                    return true;
                }
                return false;
            }
            ...
            function isLoaded() {
                if (!qz) {
                    ...
                    primefacesMessages('error', 'Error Impresora!','El Plugin de Impresión no se cargó correctamente');
                    return false;
                } else {
                    try {
                        if (!qz.isActive()) {
                           
                            primefacesMessages('error', 'Error Impresora!','El Plugin se cargó pero NO esta activo');
                            return false;
                        }
                    } catch (err) {
                    	 primefacesMessages('info', 'Impresora Correcta!','El Plugin se cargó correctamente');
                        return false;
                    }
                }
                return true;
            ...
            function qzDonePrinting() {
                // Alert error, if any
                 mostrarDivProcesamientoInformacion();
                if (qz.getException()) {
                ...
                // Alert success message
             	  ocultarDivProcesamientoInformacion();
                primefacesMessages('info', 'Impresión Correcta','La Impresión se realizó satisfactoriamente');
            }
            ...
            function useDefaultPrinter() {
                 console.log('comprobando la impresora por defecto');
                 mostrarDivProcesamientoInformacion();
                if (isLoaded()) {
                    ...
                    window['qzDoneFinding'] = function() {
                        ...
                        if(printer!==null){
                        	 primefacesMessages('info', 'Impresora por Defecto Encontrada',printer);
                        	 $("#impresoraConfigurada").html();
                        	 $("#impresoraConfigurada").html('<b> Impresora Configurada:  '+printer+'</b>');
                        }else{
                        	 primefacesMessages('error', 'Impresora por Defecto No Encontrada','Por favor instale una impresora por defecto adecuada');
                        	
                        	 $("#impresoraConfigurada").html();
                        	 $("#impresoraConfigurada").html('<div class="ui-message ui-message-error ui-widget ui-corner-all" aria-live="polite"><span class="ui-message-error-detail">Error!, No hay Impresora Configurada</span></div>');
             ...
             function findPrinters() {
                 ...
                 if (isLoaded()) {
                     ...
                     window['qzDoneFinding'] = function() {
                         ...
                         var $select = $('#selectImpresoras'); 
                         $select.find('option').remove(); 
                         $select.append("<option value=''>Seleccione Impresora</option>"); 
                         for (i in printers) {
                           //  primefacesMessages('info', 'Impresora Instalada',printers[i] ? printers[i] : 'Unknown');
                             console.log("Impresora Instalada:  "+printers[i] ? printers[i] : 'Unknown');
                             var impresora=printers[i];
                             $select.append('<option value="'+impresora+'">' + impresora + '</option>');
                             bandera = true;
                         }
                 ...
                 primefacesMessages('info', 'Proceso Correcto!','Las impresoras se cargaron correctamente');
                 
             }

             function printHTML() {
                 console.log("Entrando a Imprimir el HTML")
                 if (notReady()) {
                     return;
                 }
                 qz.appendHTML('<html><h3>*******  EEBP  ******</h3><h5>Empresa de Energía del Bajo Putumayo</h5><br/>Canción</html>');
                 qz.printHTML();
             }
            ...
            function findPrinter(name) {
                ...
                console.log("Entrando al findPrinter");
                ...
                if (isLoaded()) {
                    ...
                    window['qzDoneFinding'] = function() {
                        ...
                        if(printer !==null){
                        	 primefacesMessages('info', 'Impresora Encontrada',printer);
                        }else{
                        	 primefacesMessages('error', 'Impresora No Encontrada',p.value);
                            }
           ...
           function buscarImpresora(impresora){
            	 if(impresora!==''){
                     if (isLoaded()) {
                         ...
                         window['qzDoneFinding'] = function() {
                             var printer = qz.getPrinter();
                             if(printer !==null){
                             	 primefacesMessages('info', 'Impresora Seleccionada',printer);
                             	 $("#impresoraConfigurada").html();
                            	 $("#impresoraConfigurada").html('<b> Impresora Configurada:  '+printer+'</b>');
                             }else{
                             	 primefacesMessages('error', 'Impresora No Encontrada',impresora);
                             	 $("#impresoraConfigurada").html();
                            	 $("#impresoraConfigurada").html('<div class="ui-message ui-message-error ui-widget ui-corner-all" aria-live="polite"><span class="ui-message-error-detail">Error!, No hay Impresora Configurada</span></div>');
                                 }
                             window['qzDoneFinding'] = null;
               		...
               		primefacesMessages('error', 'Impresora Requerida','Por favor seleccione una Impresora');
                 }
            }
            ...
            function printHTML() {
                ...
                qz.appendHTML('<html><h3>*******  EEBP  ******</h3><h5>Empresa de Energía del Bajo PUtumayo</h5></html>');
                qz.printHTML();
            }


			function imprimirPaginaPrueba(){
				console.log(" Imprimiendo página de Prueba div");
				 mostrarDivProcesamientoInformacion();
			    if (notReady()) {
                    return;
                }
			    var texto = $(".textoPrueba").text();
			    console.log(texto);



			    var horaFecha = getHoraFecha();
	          	...
	          	qz.appendHTML('<html>'+
	        		   '<div id="divEncabezado" style="font-face:\'Courier New\'; text-align: center;">'+
	        		   			'<span style="font-weight: bold;font-size:8pt;">Empresa de Energia del Bajo Putumayo</span><br />'+
	        		   			'<span style="font-size:8pt;">S.A E.S.P</span><br />'+
	        		   			'<span style="font-size:8pt;">NIT 846000553-0</span><br />'+
	        		   	'</div>'+
	        		   	'<span>'+texto+'</span><br />'+
	        		   
	        		   	
	        			'<div id="divPiePagina" style="font-face:\'Courier New\'; text-align: center;">'+
	        					'<span style="font-size:8pt;">'+horaFecha+'</span><br />'+
		      		   			'<span style="font-size:8pt;">Generamos Desarrollo con Energia</span><br />'+
       				   			'<span style="font-size:8pt;">www.eebpsa.com.co</span><br />'+
       		   					'<span style="font-weight: bold;font-size:8pt;">Desarrollado por</span><br />'+
       		   					'<span style="font-weight: bold;font-size:8pt;">Eyder Albeiro Ascuntar Rosales</span><br />'+
       		   			'</div>'+
	        		  ' </html>');
                qz.printHTML();
			}
			...
			function reImprimirTicketRecaudo(nroFactura, nomSuscriptor,
					 codSuscriptor, dirSuscriptor, valorTotal,
					 codVerificacion, fechaRecaudo,horaRecaudo, entidad, lugar, oficina, cajero){
				nomSuscriptor = truncate(nomSuscriptor, 30);
		        dirSuscriptor = truncate(dirSuscriptor, 25);
			 	qz.appendHTML('<html>'+
		          		'<div id="divEncabezado" style="font-face:\'Courier New\'; text-align: center;">'+
        		   			'<span style="font-weight: bold;font-size:8pt;">Empresa de Energia del Bajo Putumayo</span><br />'+
        		   			'<span style="font-size:8pt;">S.A E.S.P</span><br />'+
        		   			'<span style="font-size:8pt;">NIT 846000553-0</span><br />'+
        		   	    '</div>'+
		        		'<span style="font-size:8pt;">Nro Factura:</span><br />'+
		        		'<span >'+nroFactura+'</span><br />'+
		        		'<span style="font-size:8pt;">Suscriptor:</span><br />'+
		        		'<span style="font-size:8pt;">'+nomSuscriptor+'</span><br />'+
	                    '<span style="font-size:8pt;">Cod Suscriptor: '+codSuscriptor+'</span><br />'+
	                    '<span style="font-size:8pt;">Direccion: '+dirSuscriptor+'</span><br />'+
	                    '<span >TOTAL: '+valorTotal+'</span><br />'+  
	                    '<span style="font-size:8pt;">Fecha: '+fechaRecaudo+'</span><br />'+  
	                    '<span style="font-size:8pt;">Hora: '+horaRecaudo+'</span><br />'+
	                    '<span style="font-size:8pt;">Entidad Recaudo: '+entidad+'</span><br />'+  
	                    '<span style="font-size:8pt;">Lugar: '+lugar+'</span><br />'+
	                    '<span style="font-size:8pt;">Oficina: '+oficina+'</span><br />'+ 
	                    '<span style="font-size:8pt;">Cajero: '+cajero+'</span><br />'+  
	                    '<span >Cod Verificacion:</span><br />'+
	                    '<span >'+codVerificacion+'</span><br />'+ 
			...
			function imprimirTicketRecaudo(){
						console.log(" Imprimiendo Ticket Recaudo");
						 mostrarDivProcesamientoInformacion();
					    if (notReady()) {
		                    return;
		                }
		         var nroFactura = $("#nroFactura").text();        
				 var nomSuscriptor = $("#nomSuscriptor").text();
				 nomSuscriptor = truncate(nomSuscriptor, 30);
		         var codSuscriptor = $("#codSuscriptor").text();
		         var dirSuscriptor = $("#dirSuscriptor").text();
		         dirSuscriptor = truncate(dirSuscriptor, 25);
		         var valorTotal = $(".valorTotal").text();
		         var codVerificacion = $("#codVerificacion").text();
		         var fechaRecaudo = $(".fechaRecaudo").text();
		         var horaRecaudo = $(".horaRecaudo").text();
		         var entidad = $("#entidad").text();
		         var lugar = $("#lugar").text();
		         var oficina = $("#oficina").text();
		         var cajero = $("#cajero").text();
			          	qz.appendHTML('<html>'+
			          		'<div id="divEncabezado" style="font-face:\'Courier New\'; text-align: center;">'+
	        		   			'<span style="font-weight: bold;font-size:8pt;">Empresa de Energia del Bajo Putumayo</span><br />'+
	        		   			'<span style="font-size:8pt;">S.A E.S.P</span><br />'+
            ...
            function listNetworkInfo() {
                if (isLoaded()) {
                    ...
                    // Automatically gets called when "qz.()" is finished.
